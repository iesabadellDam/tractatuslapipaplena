...
Copiar los archivos libeay32.dll y ssleay32.dll de la carpeta xamppphp en la carpeta xamppapachebin , sobreescribiendo los existentes.

Editar el fichero php.ini  que puede encontrarse en alguno de los siguienetes directorios:  xamppapachebin o xamppphp y descomentar la linea:
