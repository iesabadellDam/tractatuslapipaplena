...
Para incluir en el menú contextual la opción "Abrir como root", en "acciones personalizadas", "añadir", colocar en el cuadro de diálogo:
...
Y en condiciones generales, clicamos en directorio. 
