...
>$ hg init [directorio] . (crea un repositorio en el directorio actual o en el que se especifique)
...
>$ hg clone ssh://usuario@servidor.com/carpeta repositorio (clona carpeta usando ssh en el directorio repositorio de el directorio actual)
